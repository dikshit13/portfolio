...
export const About = () => {
  return (
    <section
      id="about-me"
      className="w-full flex flex-col items-center justify-center py-20 px-4 sm:px-8 md:px-10 lg:px-10"
    >
      <motion.div
      ...
      <div className="w-full max-w-4xl mx-auto flex flex-col md:flex-row gap-6 md:gap-10 items-center">
        {/* About Content */}
        <motion.div
